...
import RealRegisterImage from "../../../assets/realRegister.png";
    ...
    <div className="min-h-screen flex -mt-8">
      <div className="flex-1 flex items-center justify-center px-8 py-12 dark:bg-slate-900" style={{ backgroundColor: "#f7f3ef" }}>
        <div className="w-full max-w-md">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-slate-900 dark:text-white mb-1">Welcome!</h1>
            <h2 className="text-3xl font-bold mb-4">
              <span style={{ color: P }}>Sign up</span>{" "}
          ...
          <div className="space-y-3 mb-6">
            <button type="button" className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-slate-900 dark:bg-slate-800 text-white rounded-xl hover:opacity-90 transition font-medium text-sm">
              <FaApple className="text-base" /> Sign up with Apple
            </button>
            <button type="button" className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-300 rounded-xl hover:bg-slate-50 dark:hover:bg-slate-800 transition font-medium text-sm">
              <FaGoogle className="text-base" /> Sign up with Google
            </button>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1.5">
                Phone Number <span style={{ color: P }}>*</span>
              </label>
              <input type="tel" value={phone} onChange={(e) => setPhone(e.target.value)}
                placeholder="+250 781 940 884" required className={inputClass} />
            </div>
            ...
            <div>
              <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1.5">
                Confirm Password <span style={{ color: P }}>*</span>
              </label>
              <div className="relative">
            ...
            <div className="flex items-start gap-2 pt-1">
              ...
              <label htmlFor="terms" className="text-xs text-slate-500 dark:text-slate-400 cursor-pointer">
                ...
                <Link to="/terms" className="underline" style={{ color: P }}>terms of service</Link>
              </label>
            </div>
          ...
          <p className="mt-6 text-center text-sm text-slate-500 dark:text-slate-400">
            ...
            <Link to="/login" className="font-semibold" style={{ color: P }}>Sign In</Link> {/* ✅ */}
          </p>
        </div>
      </div>
      ...
      <div className="hidden lg:flex flex-1 items-center justify-center dark:bg-slate-800 p-12" style={{ backgroundColor: "#ede8e3" }}>
        <div className="max-w-xl">
          ...
          <img src={RealRegisterImage} alt="Sign up illustration" className="w-full h-auto" />
        </div>
      </div>
    </div>
  );
